...
const AdminProjectBidFormEdit = ({ editData, onProjectBidEditUpdate, onFormEditClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    PortalID: editData.portals ? editData.portals[0].ID : ""
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onProjectBidEditUpdate(formData, e);
  };
    ...
    <div style={{ padding: "20px" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", gap: "10px" }}>
          ...
          <button type="button" onClick={onFormEditClose} style={{ padding: "10px 20px", backgroundColor: "#6c757d", color: "#fff", border: "none" }}>
            Cancel
          </button>
        </div>
      </form>
